...
class TestDatabase(unittest.TestCase):
    ...
    def test_database_construction_links_approaches_to_neos(self):
        for des, list_approaches in self.approaches.items():
    ...
    def test_database_construction_ensures_each_neo_has_an_approaches_attribute(self):
        for des, neo in self.neos.items():
    ...
    def test_database_construction_ensures_neos_collectively_exhaust_approaches(self):
        ...
        for des, apps in self.approaches.items():
            for app in apps:
                approaches_app.add(app)
        self.assertEqual(approaches, approaches_app)
    ...
    def test_get_neo_by_designation(self):
        ...
        self.assertEqual(cerberus.nombre, 'Cerberus')
        ...
        self.assertEqual(adonis.nombre, 'Adonis')
        ...
        self.assertEqual(tantalus.nombre, 'Tantalus')
    ...
    def test_get_neo_by_designation_neos_with_year(self):
        ...
        self.assertEqual(bs_2020.nombre, None)
        ...
        self.assertEqual(py1_2020.nombre, None)
    ...
    def test_get_neo_by_name(self):
        ...
        self.assertEqual(lemmon.nombre, 'Lemmon')
